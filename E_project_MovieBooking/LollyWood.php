...
?>
<div class="container">
	<h1 class='mt-4' style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; color:brown">Lolly Wood</h1>
...
<?php
				if(isset($_GET['A'])){
						...
						if($coun==0){
                           echo "<h2 class='text-warning' style='font-family:Arial; font-size:30px'>Lollywood Movies Coming Soon</h2>";
						}
						$counter = 0;
