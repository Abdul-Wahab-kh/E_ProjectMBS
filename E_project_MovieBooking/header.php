 ...
 <div class='row top_1'>
  <div class='col-md-2'>
   <div class='top_1l pt-1'>
    <h4 class='mb-0'><a class='text-white' href='index.php'><i class='fa fa-video-camera col_red me-1'></i>MovieBooking</a></h4>
   </div>
  </div>
  <div class='col-md-4'>
   <div class='top_1m'>
    ...
    <img src=<?php echo "pics/".$_SESSION['i'];?> width='20px' height='20px' class='rounded-circle'>
      ...
      <div class="card ms-4 bg-dark">
        ...
        <div class="wishlist-border pt-2">
          <span class="wishlist text-light">Tickets</span>
        </div>
...
<nav class='navbar navbar-expand-md navbar-light' id='navbar_sticky' style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
  <div class='container'>
    <a class='navbar-brand text-white' href='index.php'><i class='fa fa-video-camera col_red me-1'></i>MovieBooking</a>
    ...
    <div class='collapse navbar-collapse' id='navbarSupportedContent'>
      <ul class='navbar-nav mb-0'>
        ...
        <li class='nav-item'>
        <a class='nav-link' href='ticketprice.php'>Pricing</a>
      </li>
		<li class='nav-item dropdown'>
          <a class='nav-link dropdown-toggle' href='#' id='navbarDropdown' role='button' data-bs-toggle='dropdown' aria-expanded='false'>
            Pages
...
<nav class='navbar navbar-expand-md navbar-light' id='navbar_sticky' style='font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;'>
  <div class='container'>
    <a class='navbar-brand text-white' href='index.php'><i class='fa fa-video-camera col_red me-1'></i>Movie Booking</a>
    <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarSupportedContent' aria-controls='navbarSupportedContent' aria-expanded='false' aria-label='Toggle navigation'>
      <span class='navbar-toggler-icon'></span>
    </button>
    <div class='collapse navbar-collapse' id='navbarSupportedContent'>
