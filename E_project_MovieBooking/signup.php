...
if(isset($_POST['btnsignup'])){
   ...
   if($e==$fetch['Email']){
    echo "<script>document.getElementById('emailerror').innerHTML='Please try another Email. Email is already Sign Up';</script>";
    ...
    if($p==$cp){
       ...
       $insert=mysqli_query($con,"insert into tblsignup values('null','$fn $ln','$e','$p','$f',default)");
